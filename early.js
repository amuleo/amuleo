...
// کامپوننت ساده آکاردئون برای بخش‌های قابل باز و بسته شدن
const Accordion = ({ title, children }) => {
  const [isOpen, setIsOpen] = useState(false);

  // آیکون فلش رو به پایین برای نمایش وضعیت باز/بسته بودن آکاردئون
  ...
  return (
    <div className="border border-gray-200 rounded-lg overflow-hidden mb-4 dark:border-gray-700">
      <button
        className="flex justify-between items-center w-full p-4 text-lg font-semibold text-right text-gray-700 bg-gray-50 hover:bg-gray-100 focus:outline-none focus-visible:ring focus-visible:ring-purple-500 focus-visible:ring-opacity-75 rounded-t-lg dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700"
      ...
      <div
        ...
        style={{ maxHeight: isOpen ? '1000px' : '0' }} // افزایش max-height برای اطمینان از نمایش کامل محتوا
      >
        <div className="p-4 bg-white text-gray-700 leading-relaxed text-justify dark:bg-gray-900 dark:text-gray-300">
          {children}
        </div>
      </div>
    </div>
...
const App = () => {
  // وضعیت برای تنظیمات خواب (مثلاً زمان بیداری هدف)
  const [sleepSetting, setSleepSetting] = useState('');
  // وضعیت برای اهداف سحرخیزی، شامل وضعیت تکمیل آن‌ها
  const [morningGoals, setMorningGoals] = useState([
    { id: 1, text: 'بیدار شدن در زمان مشخص (تنظیم خواب)', completed: false },
    { id: 2, text: 'نوشیدن یک لیوان آب بلافاصله پس از بیداری', completed: false },
    { id: 3, text: 'انجام ۵ دقیقه حرکات کششی یا نرمش سبک', completed: false },
    { id: 4, text: 'مدیتیشن یا تمرکز بر تنفس به مدت ۱۰ دقیقه', completed: false },
    { id: 5, text: 'نوشتن سه چیزی که بابت آن‌ها شکرگزار هستید', completed: false },
    { id: 6, text: 'برنامه‌ریزی برای سه کار مهم روز', completed: false },
    { id: 7, text: 'خواندن ۱۰ دقیقه از یک کتاب الهام‌بخش', completed: false },
    { id: 8, text: 'گوش دادن به موسیقی آرامش‌بخش', completed: false },
    { id: 9, text: 'مرور اهداف بلندمدت', completed: false },
    { id: 10, text: 'لبخند زدن به خود در آینه', completed: false },
  ]);
  ...
  const guideSections = [
    ...
    },
    {
      ...
      content: (
        <>
          <h3 className="text-xl font-bold text-gray-700 mb-2 text-right">تجربه کاربران در تغییر زمان بیداری</h3>
          <p className="mb-2">کلید تغییر برنامه خواب، به ویژه از ۲ بامداد به ۶ صبح، انجام تدریجی آن است. این کار مانند تنظیم یک ابزار ظریف است. بسیاری از کاربران و متخصصان بر این رویکرد تأکید دارند.</p>
          <p className="mb-2">تغییرات کوچک و تدریجی، مقاومت ذهنی را از بین می‌برد. منابع متعدد به شدت تغییرات تدریجی (۱۵ تا ۳۰ دقیقه زودتر) را برای تنظیم خواب توصیه می‌کنند. کاربران به صراحت اذعان می‌کنند که بدن و ذهن در برابر تغییرات ناگهانی "مقاومت" خواهند کرد. برای فردی با OCD، که اغلب اضطراب بالایی در مورد تغییر و تمایلات کمال‌گرایانه را تجربه می‌کند، یک تغییر شدید می‌تواند ترس شدید از شکست یا افزایش اجبارها را تحریک کند. با این حال، تغییرات تدریجی، این تهدید درک شده را کاهش می‌دهند و اعتماد به نفس را از طریق موفقیت‌های کوچک و مداوم ایجاد می‌کنند. با کمتر ترسناک کردن تغییر، احتمال اینکه فرد اضطراب و انعطاف‌ناپذیری ذهنی را تجربه کند که می‌تواند تلاش‌های او را مختل کند، کاهش می‌یابد. هر تغییر کوچک و موفقیت‌آمیز به عنوان یک تقویت‌کننده مثبت عمل می‌کند و به آرامی مغز را برای پذیرش برنامه جدید بدون تحریک واکنش "جنگ یا گریز" مرتبط با وضعیت فرد، بازبرنامه‌ریزی می‌کند. این نه تنها یک توصیه عمومی برای بهداشت خواب است، بلکه یک راهبرد روان‌شناختی حیاتی است که برای افراد دارای OCD طراحی شده است. این راهبرد از اصل "عادت‌های کوچک" برای مدیریت مقاومت و اضطراب ذاتی استفاده می‌کند و مسیر رسیدن به الگوی خواب جدید را قابل دستیابی و پایدار می‌سازد تا اینکه طاقت‌فرسا به نظر برسد.</p>
          <p className="mb-2">یک کاربر توصیه بسیار عملی را به اشتراک گذاشته است: "اگر روز ده صبح بیدار می شدید از فردا سعی کنید ربع ساعت زودتر بیدار بشوید یعنی یک ربع به ده صبح بیدار بشوید البته با حس و حال خوب و با شکرگزاری یک روند را ممکن است تا یک هفته و یا حتی بیشتر هم ادامه بدهید". این رویکرد ملایم به بدن و ذهن کمک می‌کند تا بدون احساس فشار زیاد، سازگار شوند. کاربر دیگری بر مقاومت اولیه تأکید کرد: "قطعا چون شبش کم خوابیدی بدنت مقاومت می کنه ولی باید به زور بیدار بشی"، که نشان می‌دهد در ابتدا، کمی اراده برای غلبه بر الگوهای قدیمی لازم است. این "اجبار" اولیه در فاز اولیه تغییر بسیار قدرتمند است. در حالی که تدریجی بودن کلیدی است، تجربه یک کاربر نشان می‌دهد که در مراحل اولیه، مقداری "اجبار" برای بیدار شدن در زمان جدید و کمی زودتر ضروری است. برای فردی با OCD، شکستن یک الگوی عمیقاً ریشه‌دار (مانند خواب دیرهنگام ناشی از نشخوار فکری) اغلب نیاز به یک فشار اولیه و آگاهانه در برابر تمایل درونی به ماندن در رختخواب یا نشخوار فکری دارد. "مقاومت" ذکر شده در [16] و [19] دقیقاً همین مانع ذهنی است. با پایبندی مداوم به زمان بیداری جدید و کمی زودتر، حتی در صورت خستگی، ریتم شبانه‌روزی بدن یک نشانه خارجی قوی و ثابت دریافت می‌کند. این سیگنال خارجی ثابت به تدریج بر بی‌نظمی داخلی ناشی از نشخوار فکری و الگوهای خواب نامنظم گذشته غلبه می‌کند و به بازآموزی ساعت بیولوژیکی کمک می‌کند. این "اجبار" اولیه، هنگامی که به صورت تدریجی و در گام‌های کوچک اعمال شود، به عنوان یک مداخله رفتاری قدرتمند عمل می‌کند. این به معنای ایجاد یک "اجبار" جدید و سالم‌تر – پایبندی منظم به برنامه بیداری – برای جایگزینی تدریجی الگوهای ذهنی و رفتاری ناسالم است که به خواب دیرهنگام کمک می‌کنند. این یک راه برای بازبرنامه‌ریزی فعال ساعت داخلی و به تبع آن، الگوهای ذهنی است.</p>

          <h3 className="text-xl font-bold text-gray-700 mb-2 text-right">جدول: برنامه گام به گام تنظیم ساعت خواب</h3>
          <div className="overflow-x-auto mb-4 rounded-lg shadow-md">
            <table className="min-w-full bg-white border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
              <thead>
                <tr className="bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
                  <th className="py-2 px-4 border-b text-right dark:border-gray-700">هفته/مرحله</th>
                  <th className="py-2 px-4 border-b text-right dark:border-gray-700">هدف زمان خواب (مثال)</th>
                  <th className="py-2 px-4 border-b text-right dark:border-gray-700">هدف زمان بیداری (مثال)</th>
                  <th className="py-2 px-4 border-b text-right dark:border-gray-700">میزان تغییر</th>
                  <th className="py-2 px-4 border-b text-right dark:border-gray-700">نکات کلیدی</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**شروع**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۲:۰۰ بامداد</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۹:۰۰ صبح</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">-</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">نقطه شروع فعلی</td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-700">
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**هفته ۱**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱:۴۵ بامداد</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۸:۴۵ صبح</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۵ دقیقه زودتر</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">هر روز، حتی تعطیلات، به این زمان پایبند باشید. آلارم را دور از دسترس بگذارید.</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**هفته ۲**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱:۳۰ بامداد</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۸:۳۰ صبح</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۵ دقیقه زودتر</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">به محض بیدار شدن، از تخت بیرون بیایید.</td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-700">
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**هفته ۳**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱:۱۵ بامداد</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۸:۱۵ صبح</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۵ دقیقه زودتر</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">صبحانه را حذف نکنید.</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**هفته ۴**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱:۰۰ بامداد</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۸:۰۰ صبح</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۵ دقیقه زودتر</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">در طول روز از نور طبیعی خورشید بهره ببرید.</td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-700">
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**هفته ۵**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۲:۴۵ بامداد</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۷:۴۵ صبح</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۵ دقیقه زودتر</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">به تدریج به هدف ۶ صبح نزدیک شوید.</td>
                </tr>
                <tr>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**هفته ۶**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۲:۳۰ بامداد</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۷:۳۰ صبح</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">۱۵ دقیقه زودتر</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">در صورت عدم موفقیت، به مرحله قبل بازگردید و تمرین کنید.</td>
                </tr>
                <tr className="bg-gray-50 dark:bg-gray-700">
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300">**... ادامه تا رسیدن به هدف ۶ صبح...**</td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300"></td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300"></td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300"></td>
                  <td className="py-2 px-4 border-b dark:border-gray-700 dark:text-gray-300"></td>
    ...
    },
    {
      ...
      content: (
        <>
          <p className="mb-2">مدیریت وسواس فکری-عملی و نشخوار فکری، به ویژه در ارتباط با تنظیم خواب، نیازمند یک رویکرد جامع و تدریجی است. این وضعیت یک چرخه خودتداوم‌بخش را ایجاد می‌کند که در آن افکار مزاحم و اضطراب ناشی از آنها، خواب را مختل کرده و کمبود خواب به نوبه خود نشخوار فکری و اضطراب را تشدید می‌کند.</p>
          <p className="mb-2">برای شکستن این چرخه و دستیابی به یک الگوی خواب پایدار و سالم، گام‌های عملی زیر توصیه می‌شود:</p>
          <ol className="list-decimal list-inside space-y-1">
            <li>**تنظیم تدریجی ساعت خواب:** تغییر زمان خواب و بیداری به صورت تدریجی (۱۵ تا ۳۰ دقیقه زودتر در هر چند روز) به بدن و ذهن اجازه می‌دهد تا بدون مقاومت شدید، سازگار شوند. این رویکرد به ویژه برای افراد دارای OCD، که ممکن است نسبت به تغییرات ناگهانی اضطراب بیشتری داشته باشند، مؤثر است.</li>
            <li>**ثبات در برنامه خواب:** پایبندی به یک برنامه خواب ثابت، حتی در آخر هفته‌ها، برای تنظیم مجدد ریتم شبانه‌روزی بدن حیاتی است. این ثبات به عنوان یک لنگر بیولوژیکی عمل کرده و به بهبود تنظیم هیجانی و کاهش آسیب‌پذیری فیزیولوژیکی در برابر اضطراب کمک می‌کند.</li>
            <li>**ایجاد روتین شبانه آرامش‌بخش:** انجام فعالیت‌های آرامش‌بخش مانند حمام آب گرم، مطالعه کتاب چاپی، گوش دادن به موسیقی آرام، مدیتیشن یا تمرینات تنفس عمیق قبل از خواب، به ذهن کمک می‌کند تا از چرخه‌های نشخوار فکری خارج شده و به حالت آرامش منتقل شود. این اقدامات به طور فعال فضای ذهنی را که نشخوار فکری معمولاً اشغال می‌کند، جایگزین می‌کنند.</li>
            <li>**پرهیز از محرک‌ها و بهینه‌سازی محیط خواب:** حذف دستگاه‌های الکترونیکی از اتاق خواب، اجتناب از وعده‌های غذایی سنگین، کافئین و الکل قبل از خواب، و ایجاد یک محیط خواب آرام، تاریک و خنک، به محافظت از "پناهگاه خواب" در برابر تحریکات شناختی و فیزیولوژیکی کمک می‌کند. این کار به مغز اجازه می‌دهد تا اتاق خواب را منحصراً با استراحت مرتبط بداند.</li>
            <li>**مدیریت فعال نشخوار فکری:** استفاده از تکنیک "وقت نگرانی" برای اختصاص دادن زمان مشخصی در طول روز به افکار نگران‌کننده، به فرد کمک می‌کند تا کنترل افکار مزاحم را به دست گیرد. به چالش کشیدن افکار منفی، تمرین ذهن‌آگاهی و حواس‌پرتی‌های سازنده، و تمرکز بر راه‌حل‌ها و اهداف واقع‌بینانه نیز از راهکارهای مؤثر در کاهش نشخوار فکری هستند.</li>
            <li>**پذیرش و شفقت به خود:** پذیرش واقعیت وسواس و نشخوار فکری، و تمرین شفقت به خود، گام‌های اساسی در مسیر بهبودی هستند. این پذیرش به فرد کمک می‌کند تا با خود مهربان‌تر باشد و از سرزنش خود که نشخوار فکری را تغذیه می‌کند، جلوگیری کند.</li>
            <li>**سبک زندگی سالم:** ورزش منظم و رژیم غذایی متعادل، به طور کلی سلامت روان و کیفیت خواب را بهبود می‌بخشند.</li>
            <li>**جستجوی حمایت حرفه‌ای:** در صورت شدت یافتن علائم، مراجعه به روانشناس یا روانپزشک برای دریافت درمان‌های تخصصی مانند CBT و مواجهه‌درمانی، و همچنین پیوستن به گروه‌های حمایتی، می‌تواند بسیار کمک‌کننده باشد.</li>
          </ol>
          <p className="mt-2">با پیاده‌سازی تدریجی و مداوم این گام‌ها، فرد می‌تواند کنترل بیشتری بر افکار خود پیدا کرده، ریتم خواب خود را تنظیم کند و در نهایت کیفیت زندگی خود را به طور قابل توجهی بهبود بخشد. این مسیر نیازمند صبر، پیوستگی و تعهد است، اما نتایج آن در بهبود سلامت روان و جسمی بسیار ارزشمند خواهد بود.</p>
        </>
      ),
    },
  ];

  // وضعیت برای مدیریت تم (روشن/تاریک)
  const [theme, setTheme] = useState(() => {
    // تلاش برای بارگذاری تم از localStorage
    const savedTheme = localStorage.getItem('theme');
    if (savedTheme) {
      return savedTheme;
    }
    // اگر تمی ذخیره نشده بود، تم سیستم را تشخیص دهید
    return window.matchMedia('(prefers-color-scheme: dark)').matches ? 'dark' : 'light';
  });

  // useEffect برای تشخیص تغییرات تم سیستم و ذخیره تم در localStorage
  useEffect(() => {
    const mediaQuery = window.matchMedia('(prefers-color-scheme: dark)');
    const handleChange = (e) => {
      // اگر کاربر تم را به صورت دستی تنظیم کرده باشد، آن را نادیده نگیرید
      if (!localStorage.getItem('theme')) { // فقط اگر تم به صورت دستی تنظیم نشده باشد
        setTheme(e.matches ? 'dark' : 'light');
      }
    };

    mediaQuery.addEventListener('change', handleChange);
    localStorage.setItem('theme', theme); // ذخیره تم فعلی در localStorage

    // اعمال کلاس 'dark' به عنصر <html>
    if (theme === 'dark') {
  ...
  }, [theme]); // وابستگی به theme برای ذخیره تغییرات دستی

  // تابع برای تغییر دستی تم
  const toggleTheme = () => {
    setTheme((prevTheme) => {
      const newTheme = prevTheme === 'light' ? 'dark' : 'light';
      localStorage.setItem('theme', newTheme); // ذخیره انتخاب دستی کاربر
      return newTheme;
    });
  };

  return (
    // Tailwind CSS CDN و فونت Vazirmatn به صورت مستقیم در HTML اضافه شده‌اند
    <>
      <script src="https://cdn.tailwindcss.com"></script>
      <link href="https://fonts.googleapis.com/css2?family=Vazirmatn:wght@100..900&display=swap" rel="stylesheet" />
      <div className={`min-h-screen p-4 font-vazirmatn text-gray-800 transition-colors duration-300 ${
        theme === 'dark' ? 'bg-gradient-to-br from-gray-900 to-gray-700 text-gray-200' : 'bg-gradient-to-br from-blue-100 to-purple-200 text-gray-800'
      }`} dir="rtl"> {/* اضافه شدن dir="rtl" */}
        <style>
          {`
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-2xl p-6 md:p-8 space-y-8 dark:bg-gray-900 dark:shadow-none">
          {/* دکمه تغییر تم */}
          <div className="flex justify-end mb-4">
            <button
              onClick={toggleTheme}
              className="p-2 rounded-full bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 shadow-md hover:scale-105 transition-transform duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
          ...
          <header className="text-center mb-8">
            <h1 className="text-4xl md:text-5xl font-extrabold text-blue-700 dark:text-blue-400 mb-2">
              برنامه سحرخیزی و الهام‌بخش
            </h1>
            <p className="text-lg md:text-xl text-gray-600 dark:text-gray-300">
              اهداف روزانه و نقل قول‌های انگیزشی برای شروعی عالی
            </p>
          </header>

          {/* بخش اهداف سحرخیزی */}
          <section className="bg-blue-50 p-6 rounded-lg shadow-inner dark:bg-gray-800">
            <h2 className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-4 text-center">
              اهداف سحرخیزی
            </h2>
            <div className="mb-6">
              <label htmlFor="sleepSetting" className="block text-lg font-medium text-gray-700 dark:text-gray-300 mb-2">
              ...
              <input
                ...
                id="sleepSetting"
                value={sleepSetting}
                onChange={(e) => setSleepSetting(e.target.value)}
                placeholder="مثال: ۶:۰۰ صبح"
                className="w-full p-3 border border-blue-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-200 dark:placeholder-gray-400 text-right" // اضافه شدن text-right
              />
            </div>
            <ul className="space-y-3">
              {morningGoals.map((goal) => (
                <li
                  key={goal.id}
                  className={`flex flex-row-reverse items-center p-3 rounded-md transition duration-200 cursor-pointer ${ // اضافه شدن flex-row-reverse
                    goal.completed
                ...
                >
                  <input
                    ...
                    className="form-checkbox h-5 w-5 text-blue-600 rounded-sm ml-3 dark:text-blue-400" // تغییر mr-3 به ml-3
                  />
                  <span className="text-lg flex-grow text-right">{goal.text}</span> {/* اضافه شدن flex-grow و text-right */}
                </li>
              ))}
            </ul>
          </section>
          ...
          {/* بخش نقل قول‌ها */}
          <section className="bg-purple-50 p-6 rounded-lg shadow-inner dark:bg-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {quotes.map((quote, index) => (
                <div
                  key={index}
                  className="bg-white p-4 rounded-lg shadow-md border border-purple-200 transform hover:scale-105 transition duration-300 ease-in-out flex flex-row-reverse items-start dark:bg-gray-700 dark:border-purple-700 dark:text-gray-200" // اضافه شدن flex-row-reverse
                >
                  <span className="text-purple-500 text-2xl font-bold ml-3">“</span> {/* تغییر mr-3 به ml-3 */}
                  <p className="text-lg text-gray-700 italic flex-grow text-right dark:text-gray-300"> {/* اضافه شدن flex-grow و text-right */}
                    {quote}
                  </p>
                </div>
              ))}
          ...
          {/* بخش راهنمای جامع مدیریت خواب و نشخوار فکری */}
          <section className="bg-green-50 p-6 rounded-lg shadow-inner dark:bg-gray-800">
            <h2 className="text-3xl font-bold text-green-700 dark:text-green-400 mb-4 text-center">
              راهنمای جامع مدیریت خواب و نشخوار فکری
            </h2>
          ...
          {/* پاورقی */}
          <footer className="text-center text-gray-500 text-sm mt-8 dark:text-gray-400">
